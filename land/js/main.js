...
var MSG_DELAY = 1e3, //e3
    TYPE_SPEED = -100000,// for fast mood -150000000
    END_LINE = 0;// for form
flow = [
    {
        type: "text",
    ...
    {type: "text", content: "В Вашем случае обязательно использование наружных средств с целебными природными ядами. "},
    ...
    {
        type: "text",
        content: "Вот так он выглядит:  <br><br> <img style='width: 250px;' src='img/product.png'>"
    },
    {
        type: "text",
    ...
    {
        type: "text", content: "Только сегодня у Вас есть возможность получить “Артрофорс” по акции за <span class=\"contry_money\"></span> " + " " + ( '<span class="contry_money">149</span>' ) + " ."
    },
    {
        type: "text",
        content: "Чтобы получить “Артрофорс”, впишите своё имя и номер телефона в форму заказа ниже. Ваши данные отправляются напрямую производителю, больше никто не имеет к ним доступа."
    },
    {
        type: "text",
        content: "Вам перезвонит специалист и после уточнения всех деталей в тот же день Вам будет отправлена посылка с курсом “Артрофорс”. " 
    },
    {
        type: "text",
